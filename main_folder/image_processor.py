...
class ImageProcessor:
    ...
    def process_frame(self, aligned_depth=False) -> ProcessedResults:
        ...
        return ProcessedResults(balls=balls, basket_b=basket_b, basket_m=basket_m, color_frame=color_frame, depth_frame=depth_frame, fragmented=self.fragmented, debug_frame=self.debug_frame)
