...
class ImageProcessor():
    ...
    def process_frame(self, aligned_depth = False) -> ProcessedResults:
        ...
        basket_b = self.analyze_baskets(depth_frame, self.t_basket_b, debug_color=c.Color.BLUE.color.tolist())
        basket_m = self.analyze_baskets(depth_frame, self.t_basket_m, debug_color=c.Color.MAGENTA.color.tolist())
