#programm shows, how dinamically change trackbar value (so you can not oly change the text on image,
# but also change variables inside the programm as well)


import cv2

# Global variable for the latest trackbar value, default is 32, now is 127
trackbar_value = 127
...
def updateValue(new_value):
    ...
    #so we can tell for the programm, that value is changed
